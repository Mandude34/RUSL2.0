...
import { Package, Receipt, AlertTriangle, ArrowRight, Loader2, Store as StoreIcon, Bell } from "lucide-react";
    ...
    <div className="space-y-7 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <Card className="border border-border bg-card shadow-xs overflow-hidden">
        ...
        <CardContent className="p-0">
          {alertCount === 0 ? (
            <div className="flex flex-col items-center justify-center py-12 px-5 text-center text-muted-foreground">
